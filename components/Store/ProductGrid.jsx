        ...
        <SimpleGrid columns={[1, 2, 3, 4]} width="100%" bg="#ffd7a6" minHeight="70vh" spacing="1rem" padding="1rem">
            {
                products.map((product) => (
                    <VStack bg='white' spacing="0" justify="start" maxHeight="512px" fontFamily="Inter" onClick={() => router.push(`/product?id=${product.id}`)} position="relative" borderRadius="1rem" _hover={{ cursor: "pointer" }}>
                        <Image src={product.imageUrl} padding="3rem" fit="contain" width="100%" height="80%" zIndex="2" bg="white" borderRadius="1rem"/>
